...
export default function SlideRenderer({ slide }: { slide: Slide }) {
  ...
  const PPTHeader = ({ title }: { title: string }) => (
    <div className="w-full flex justify-between items-end border-b-4 border-blue-900 pb-4 mb-8">
      <h1 className="text-4xl text-blue-900 font-bold tracking-wide uppercase">
        {title}
      </h1>
          ...
          <div className="z-10 relative flex flex-col h-full w-[60%]">
            ...
            <div className="flex-1 flex flex-col justify-center -mt-8">
              ...
              {slide.content?.map((text, i) => (
                <p key={i} className="text-xl text-neutral-600 font-medium">
                  {text}
                </p>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-6 pt-8 mt-auto border-t border-neutral-200">
              {slide.members?.map((m, i) => (
                <div key={i} className="flex flex-col">
                  ...
                  <span className="text-base text-neutral-500 font-medium mt-1">
                    {m.role}
                  </span>
                </div>
              ))}
          ...
          <div className="flex-1 px-8 pt-4">
            ...
            <ul className="space-y-6">
              {slide.content?.map((item, i) => (
                <li
                  key={i}
                  className="flex gap-4 items-start text-2xl text-gray-700"
                >
                  <span className="text-blue-600 font-bold text-3xl leading-none">
                    •
                  </span>
                  <span>{item}</span>
                </li>
    ...
    case "bullets":
      return (
        <div className="w-full h-full p-16 flex flex-col bg-white overflow-hidden relative">
          ...
          <div
            className={`flex-1 mt-4 min-h-0 ${slide.image ? "flex gap-12" : ""}`}
          >
            <div
              className={`h-full flex flex-col justify-center ${slide.image ? "w-[55%] shrink-0" : "w-full"}`}
            >
              <ul className="space-y-6 px-4">
                {slide.content?.map((item, i) => {
                  const isHeading =
                    item.endsWith(":") ||
                    item.includes("Kết luận:") ||
                    item.includes("Hướng phát triển:") ||
                    item.includes("Nhấn mạnh:");
                  if (isHeading && !item.includes("<b")) {
                    return (
                      <li
                        key={i}
                        className={`flex gap-4 items-start text-3xl font-bold text-blue-900 mt-8`}
                      >
                  ...
                  return (
                    <li
                      key={i}
                      className={`flex gap-4 items-start text-[1.65rem] text-neutral-800 leading-snug`}
                    >
                      <span className="text-blue-600 font-bold text-3xl leading-none shrink-0 mt-1">
                        •
                      </span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: item.replace(
                            /^([^:]+):/g,
                            '<b className="text-neutral-900">$1:</b>',
                          ),
                        }}
                      ></span>
                    </li>
            ...
            {slide.image && (
              <div className="w-[45%] h-full relative">
                <img
                  src={getImageUrl(slide.image)}
                  alt={slide.title}
                  className="absolute inset-0 w-full h-full object-cover rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-neutral-200"
                />
              </div>
            )}
          </div>
              ...
              <ul className="space-y-6">
                {slide.leftContent?.map((item, i) => {
                  ...
                  return (
                    <li
                      key={i}
                      className={`flex gap-4 items-start ${isHeading ? "text-3xl font-bold text-blue-900 mb-4 border-b pb-4" : "text-2xl text-gray-800"}`}
                    >
                      {!isHeading && (
                        <span className="text-blue-600 font-bold text-3xl leading-none shrink-0">
                          •
                        </span>
                      )}
                      <span>{item}</span>
              ...
              <ul className="space-y-6">
                {slide.rightContent?.map((item, i) => {
                  ...
                  return (
                    <li
                      key={i}
                      className={`flex gap-4 items-start ${isHeading ? "text-3xl font-bold text-green-700 mb-4 border-b pb-4" : "text-2xl text-gray-800"}`}
                    >
                      {!isHeading && (
                        <span className="text-green-600 font-bold text-3xl leading-none shrink-0">
                          •
                        </span>
                      )}
                      <span>{item}</span>
                ...
                <div className="grid grid-cols-3 gap-1 mt-1">
                  <div className="flex flex-col items-center text-center gap-1">
                    <div className="relative h-10 w-10 mb-0.5 text-blue-700/80">
                      ...
                      >
                        <path d="m11.5 6.5 2 2-2 2-2-2 2-2Z" />
                        <path d="m15.5 10.5 2 2-2 2-2-2 2-2Z" />
                        <path d="m7.5 10.5 2 2-2 2-2-2 2-2Z" />
                        <path d="M3 21h18" />
                  ...
                  <div className="flex flex-col items-center text-center gap-1">
                    <div className="h-10 w-10 text-blue-400 mb-0.5">
                      <svg
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="w-full h-full text-slate-400 relative z-10 bg-white rounded-full mix-blend-multiply"
                      >
      ...
      const layers = [
        ...
        },
        {
          ...
          items: [
            ...
            {
              icon: (
                <div className="w-10 h-10 flex items-center justify-center text-blue-800">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
        ...
        <div className="w-full h-full p-8 flex flex-col bg-white overflow-hidden relative">
          ...
          <div className="flex-1 flex flex-col justify-between py-2 relative mt-4 h-full z-10">
            ...
            {layers.map((layer, index) => (
              <div
                key={layer.id}
                className="relative flex items-stretch w-full z-10 h-[6.5rem]"
              >
                ...
                <div className="flex-1 flex items-stretch ml-2 mr-8 relative shadow-md rounded-2xl">
                  ...
                  {/* Blue Box */}
                  <div
                    className={`w-[22rem] ${layer.bgColor} rounded-l-2xl p-4 pl-14 flex flex-col justify-center border border-r-0 border-white/20 shrink-0 z-10 relative`}
                  >
                    ...
                    <h3 className="text-white font-bold text-[22px] mb-1 drop-shadow-sm tracking-tight">
                      {layer.title}
                    </h3>
                    <p className="text-blue-50 text-[14px] leading-snug drop-shadow-sm pr-4 opacity-90">
                      {layer.subtitle}
                    </p>
                  </div>
                    ...
                    <div className="grid grid-cols-4 w-full h-full items-center px-2 pt-2">
                      {layer.items.map((item, i) => (
                        ...
                        >
                          {item && (
                            <>
                              <div className="text-blue-800">{item.icon}</div>
                    ...
                    {layer.id === 4 && (
                      <div className="absolute top-[8rem] left-[14rem] w-52 bg-white border border-slate-200 rounded-xl p-3 shadow-lg z-20">
                        ...
                        <p className="text-[11px] text-slate-500 leading-relaxed font-medium">
                          Dự báo chỉ mang tính tham khảo, không thay thế quyết
                          định của người trồng.
                        </p>
                      </div>
                    )}
                  </div>
            ...
            <div className="absolute -top-[1.5rem] right-[2rem] w-[16.5rem] h-[33rem] bg-white rounded-[2.5rem] border-[8px] border-slate-300 shadow-xl z-0 opacity-40 pointer-events-none flex flex-col overflow-hidden">
              ...
              <div className="flex-1 bg-slate-50 p-4 flex flex-col gap-3 overflow-y-auto w-full relative z-30 border-t border-slate-100">
                <div className="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[14px] font-bold text-gray-800 leading-tight mb-1">
                      Dự báo Giá Cà Phê
                    </div>
                    <div className="text-[11px] text-gray-500 leading-[1.3]">
                      Xem dự báo giá ở các tháng tới, mức độ tin cậy.
                    </div>
                  </div>
                </div>
                <div className="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex items-center gap-3">
                  <div className="p-2.5 bg-green-50 rounded-lg text-green-600">
                    <svg
                      ...
                      className="w-6 h-6"
                    >
                      <path d="M12 22C12 22 20 18 20 11C20 7.5 17.5 5 14 5C13.2 5 12.5 5.2 12 5.5C11.5 5.2 10.8 5 10 5C6.5 5 4 7.5 4 11C4 18 12 22 12 22Z" />
                    </svg>
                  </div>
                  <div>
                    <div className="text-[14px] font-bold text-gray-800 leading-tight mb-1">
                    ...
                    <div className="text-[11px] text-gray-500 leading-[1.3]">
                      Nhận lời khuyên chăm sóc vườn dựa trên thời tiết.
                    </div>
                  </div>
                </div>
                <div className="bg-white p-3 rounded-xl border border-slate-200 shadow-sm flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[11px] text-gray-500 leading-[1.3]">
                      Phòng ngừa các bệnh phổ biến mùa mưa.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full h-full p-16 flex flex-col bg-white">
          ...
          <div className="grid grid-cols-3 gap-8 mb-12">
            {slide.metrics?.map((m, i) => (
              <div
                key={i}
                className={`text-center p-8 border-4 ${i === 2 ? "border-red-600 bg-red-50" : "border-blue-900 bg-blue-50"} shadow-md`}
              >
                <h3 className="text-2xl font-bold text-gray-700 mb-4">
                  {m.label}
                </h3>
                <div
                  className={`text-5xl font-extrabold mb-2 ${i === 2 ? "text-red-700" : "text-blue-900"}`}
                >
                  {m.value}
                </div>
          ...
          <div className="bg-gray-100 p-8 border-l-8 border-blue-900 mt-auto">
            <ul className="space-y-4">
              {slide.content?.map((item, i) => (
                <li
                  key={i}
                  className="flex gap-4 items-start text-2xl text-gray-800"
                >
            ...
            <div className="space-y-12">
              {slide.chartData?.map((data, i) => (
                <div key={i} className="flex items-center gap-6">
                  <div className="w-72 text-2xl font-bold text-right text-gray-800 leading-tight shrink-0">
                    {data.label}
                  </div>
                    ...
                    >
                      <span
                        className={
                          data.value >= 15
                            ? ""
                            : "absolute left-full ml-4 text-gray-800"
                        }
                      >
                        {data.value}%
                      </span>
          ...
          <div className="bg-green-50 border border-green-200 p-6 mt-auto">
            <ul className="space-y-4">
              {slide.content?.map((item, i) => (
                <li
                  key={i}
                  className="flex gap-4 items-start text-xl text-green-900 font-bold"
                >
        ...
        },
        {
          ...
          icon: (
            ...
            >
              ...
              <path d="M3 13l6-6 4 4 8-8" strokeWidth="2" />
          ...
          <div className="flex-1 flex mt-4 gap-4 relative items-center h-full">
            ...
            <div className="w-[24rem] flex flex-col gap-4 shrink-0 z-10 pl-2 justify-center -translate-y-8 mb-8">
              {leftFeatures.map((f) => (
                <div
                  key={f.id}
                  className="relative bg-white border border-blue-200 rounded-2xl p-3 flex items-center gap-3 shadow-sm ml-4 h-[6.5rem]"
                >
                  ...
                  <div className="flex-1 pr-1">
                    <h4 className="text-[18px] font-bold text-blue-900 mb-1">
                      {f.title}
                    </h4>
                    <p className="text-[12px] text-gray-700 leading-snug whitespace-pre-line">
                      {f.desc}
                    </p>
                  </div>
                </div>
              ...
              <div className="relative flex justify-center w-[20rem] shrink-0 scale-[0.82] lg:scale-[0.88] xl:scale-[0.88] 2xl:scale-100 origin-[left_top] ml-8 mt-2">
                ...
                <div className="absolute top-[8rem] -left-[14.5rem] flex items-center gap-0 z-20">
                  <div className="bg-white border border-blue-200 rounded-xl p-3 shadow-md flex flex-col w-[12.5rem]">
                    <div className="flex items-center gap-2 mb-1.5 text-blue-600">
                      ...
                      >
                        <path d="M14 6l-4 4-1-1m8-5v22m-10-8H2v-6h4" />
                      </svg>
                    ...
                    <p className="text-[12px] text-gray-600 leading-snug">
                      Khu vực chạm rộng, dễ sử dụng ngoài hiện trường.
                    </p>
                  </div>
                  ...
                  <div className="bg-white border border-blue-200 rounded-xl p-3 shadow-md flex flex-col w-[12.5rem]">
                    <div className="flex items-center gap-2 mb-1.5 text-blue-600">
                      <svg
                        ...
                        className="w-[1.2rem] h-[1.2rem]"
                      >
                        <path d="M2.5 8.5L12 3l9.5 5.5M12 3v18M2.5 15.5l9.5 5.5m0-11l9.5-5.5" />
                      </svg>
                      <span className="font-bold text-blue-900 text-[15px]">
                        Lịch sử Offline
                      </span>
                    ...
                    <p className="text-[12px] text-gray-600 leading-snug">
                      Xem lại dự báo và khuyến nghị ngay cả khi không có mạng.
                    </p>
                  </div>
                  <div className="w-[2.5rem] h-[2px] bg-blue-400"></div>
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-400"></div>
                ...
                <div className="absolute top-[4rem] -right-[15rem] flex items-center flex-row-reverse gap-0 z-20">
                  <div className="bg-white border border-blue-200 rounded-xl p-3 shadow-md flex gap-3 items-center w-[13.5rem]">
                    ...
                    <div>
                      <span className="font-bold text-blue-900 text-[15px] block mb-0.5">
                        Mobile-first
                      </span>
                      <p className="text-[11px] text-gray-600 leading-tight">
                        Thiết kế tối ưu cho điện thoại và dùng tốt trên 3G yếu.
                      </p>
                    </div>
                  </div>
                ...
                <div className="absolute top-[13.5rem] -right-[16.5rem] flex items-center flex-row-reverse gap-0 z-20">
                  <div className="bg-white border border-gray-200 rounded-xl p-3 shadow-md flex flex-col w-[15.5rem]">
                    <div className="flex justify-between items-center mb-2 pb-2 border-b border-gray-100">
                      <span className="font-bold text-gray-700 text-[12px] flex items-center gap-1.5">
                        <svg
                          viewBox="0 0 24 24"
                          fill="none"
                          stroke="currentColor"
                          strokeWidth="2.5"
                          className="w-[1.2rem] h-[1.2rem] text-orange-500"
                        >
                          <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
                        </svg>{" "}
                        Dự báo Giá Cà Phê
                    ...
                    <div className="flex justify-between items-end">
                      ...
                      <div className="text-green-600 font-bold text-[12px] flex flex-col items-end gap-0.5 leading-tight text-right">
                        +2.8% ↗
                ...
                <div className="absolute top-[21rem] -right-[16.5rem] flex items-center flex-row-reverse gap-0 z-20">
                  <div className="bg-white border border-gray-200 rounded-xl p-3 shadow-md flex flex-col w-[15.5rem]">
                    <div className="flex justify-between items-center mb-2 pb-2 border-b border-gray-100">
                      <span className="font-bold text-gray-700 text-[12px] flex items-center gap-1.5">
                        <svg
                          ...
                          stroke="currentColor"
                          strokeWidth="2.5"
                          className="w-[1rem] h-[1rem] text-green-500"
                        >
                          <path d="M12 22C12 22 20 18 20 11C20 7.5 17.5 5 14 5C13.2 5 12.5 5.2 12 5.5C11.5 5.2 10.8 5 10 5C6.5 5 4 7.5 4 11C4 18 12 22 12 22Z" />
                        </svg>{" "}
                        Khuyến nghị hôm nay
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-gray-800 font-bold text-[12px] mb-0.5">
                          Tưới nhẹ buổi sáng
                        </div>
                ...
                <div className="absolute top-[28.5rem] -right-[14rem] flex items-center flex-row-reverse gap-0 z-20">
                  <div className="bg-white border border-blue-200 rounded-xl p-3 shadow-md flex gap-3 items-center w-[12.5rem]">
                    ...
                    <div>
                      <span className="font-bold text-blue-900 text-[13px] block mb-0.5">
                        Disclaimer rõ ràng
                      </span>
                      <p className="text-[10px] text-gray-600 leading-tight">
                        Thông báo cố định an toàn, luôn hiển thị ở cuối màn
                        hình.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col gap-3 px-4 z-10 overflow-y-auto pt-2 pb-6">
                    ...
                    <div className="bg-white rounded-[1rem] p-3 shadow-sm border border-gray-100 flex flex-col gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-gray-600 mt-1 leading-[1.35]">
                          Xem dự báo giá cà phê trong các tháng tới và mức độ
                          tin cậy.
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-[1rem] p-3 shadow-sm border border-gray-100 flex flex-col gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-gray-600 mt-1 leading-[1.35]">
                          Nhận lời khuyên chăm sóc vườn dựa trên thời tiết và
                          loại đất.
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-[1rem] p-3 shadow-sm border border-gray-100 flex flex-col gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-gray-600 mt-1 leading-[1.35]">
                          Xem lại các dự báo và lời khuyên bạn đã lưu trước đó.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 px-4 pb-4 pt-4 z-10 w-full flex justify-center bg-gradient-to-t from-[#fdfbf7] via-[#fdfbf7] to-transparent">
                    <div className="bg-orange-50 border border-orange-200 rounded-[0.5rem] p-2 flex items-start gap-1.5 w-full">
                      <svg
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="w-3.5 h-3.5 text-orange-600 shrink-0 mt-[1px]"
                      >
                        <path
                          d="M12 2L1 21h22M12 6l7 12H5M12 16h.01M12 10v4"
                          stroke="currentColor"
                          strokeWidth="2"
                        />
                      </svg>
            ...
            <div className="absolute bottom-1 left-1/2 -translate-x-1/2 bg-[#faefdf] border border-orange-200 px-6 py-2 rounded-xl flex items-center gap-3 z-30 shadow-sm w-max mb-1">
              ...
              <span className="text-orange-900 font-bold text-[14px] leading-tight">
                Dự báo chỉ mang tính tham khảo, không thay thế quyết định của
                người trồng.
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 flex mt-2 gap-12 relative items-stretch h-full">
            ...
            <div className="flex-1 pr-6 flex flex-col relative h-full">
              ...
              <div className="flex flex-col relative w-max mb-2">
                <h3 className="text-blue-800 font-bold text-2xl mb-1.5 flex items-center gap-2">
              ...
              <div className="flex-1 flex relative gap-4">
                ...
                <div className="w-[14.5rem] flex flex-col gap-6 justify-start relative pt-4">
                  ...
                  <div className="border border-blue-200 rounded-xl p-4 shadow-sm bg-white">
                    <h4 className="text-blue-800 font-bold text-[13px] text-center mb-3 pb-3 border-b border-gray-100">
                      Chú giải độ phủ dữ liệu
                    </h4>
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-xl p-3 shadow-md flex items-start gap-2 relative">
                    <div className="shrink-0 mt-0.5 relative flex items-center justify-center">
                      ...
                      <svg
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className="w-8 h-8 text-orange-500 relative z-10"
                      >
                        <path
                          d="M12 2L1 21h22M12 6l7 12H5M12 16h.01M12 10v4"
                          stroke="white"
                    ...
                    <div className="text-[11.5px] text-gray-800 leading-[1.4] text-justify mt-0.5 pr-1">
                      ...
                      <span className="font-bold text-orange-600">
                        Gia Nghĩa, Chư Prông, Cư M'gar, Đắk R'lấp
                      </span>
                      . Hệ thống phải nhắc độ tin cậy thấp khi dữ liệu có nhiều
                      proxy/nội suy.
                    </div>
                  </div>
                </div>
            ...
            <div className="flex-1 pl-12 flex flex-col relative h-full">
              ...
              <div className="flex flex-col relative w-max mx-auto mb-2 pr-12">
                <h3 className="text-green-700 font-bold text-2xl mb-1.5 align-center text-center">
              ...
              <div className="flex-1 flex justify-center relative mt-0">
                <div className="relative flex justify-center w-[16rem] shrink-0 scale-[0.74] lg:scale-[0.78] xl:scale-[0.84] origin-top ml-4 pt-0">
                  ...
                  <div className="absolute top-[4rem] -left-[11rem] flex items-center gap-0 z-20">
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 shadow-sm flex flex-col gap-1 w-[11.5rem]">
                      <div className="flex items-center gap-2 mb-1">
                        <div className="w-7 h-7 rounded shrink-0 text-blue-700 border border-blue-600 flex items-center justify-center bg-white">
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                      ...
                      <div className="text-gray-700 text-[11.5px] leading-snug pl-1">
                  ...
                  <div className="absolute top-[16rem] -left-[11rem] flex items-center gap-0 z-20">
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 shadow-sm flex flex-col gap-1 w-[11.5rem]">
                      <div className="flex items-center gap-2 mb-1">
                        <div className="w-7 h-7 rounded shrink-0 border border-blue-600 text-blue-700 flex items-center justify-center bg-white">
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                  ...
                  <div className="absolute top-[6rem] -right-[11rem] flex items-center flex-row-reverse gap-0 z-20">
                    <div className="bg-green-50 border border-green-200 rounded-xl p-3 shadow-sm flex flex-col gap-1 w-[11.5rem]">
                      <div className="flex items-center gap-2 mb-1">
                        <div className="w-7 h-7 rounded shrink-0 border border-green-600 text-green-700 flex items-center justify-center bg-white border-[1.5px]">
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                  ...
                  <div className="absolute top-[18rem] -right-[11rem] flex items-center flex-row-reverse gap-0 z-20">
                    <div className="bg-orange-50 border border-orange-200 rounded-xl p-3 shadow-sm flex flex-col gap-1 w-[11.5rem]">
                      <div className="flex items-center gap-2 mb-1">
                        <div className="w-7 h-7 rounded shrink-0 border border-orange-500 text-orange-600 flex items-center justify-center bg-white">
                          <svg
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            className="w-5 h-5"
                      ...
                      <div className="text-gray-700 text-[11.5px] leading-snug pl-1">
                        Luôn hiển thị để giảm rủi ro quyết định sai.
                      </div>
                    </div>
                    ...
                    <div className="px-5 pt-8 pb-3 bg-[#f7f2ea] z-10 flex flex-col gap-4">
                      ...
                      <div className="flex items-center gap-1.5 font-bold text-gray-800 text-[13px]">
                        <svg
                          ...
                          stroke="currentColor"
                          strokeWidth="2"
                          className="w-[1.2rem] h-[1.2rem] text-orange-800"
                        >
                          <path d="M17 8h1a4 4 0 1 1 0 8h-1" />
                          <path d="M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4Z" />
                        </svg>
                    ...
                    <div className="flex-1 flex flex-col gap-3 px-4 z-10 overflow-y-auto pt-2 pb-6">
                      ...
                      <div className="bg-white rounded-[1rem] p-3 shadow-sm border border-gray-100 flex flex-col gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-[11px] text-gray-600 mt-1 leading-[1.35]">
                            Xem lại các dự báo và lời khuyên bạn đã lưu trước
                            đó.
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="absolute -bottom-[2.5rem] left-1/2 -translate-x-1/2 w-max max-w-[28rem] bg-[#fdf5e6] border border-orange-200 px-6 py-3 rounded-xl flex items-center gap-3 z-30 shadow-md">
                    ...
                    <span className="text-gray-800 font-bold text-[14px] leading-snug">
                      Dự báo chỉ mang tính tham khảo,
                      <br />
                      không thay thế quyết định của người trồng.
                    </span>
                  </div>
                </div>
              </div>
      ...
      return (
        <div className="w-full h-full flex flex-col items-center justify-center bg-blue-950 p-16 text-center text-white relative">
          ...
          <div className="absolute top-16 left-0 w-full text-center z-10">
            <span className="text-2xl font-bold text-blue-200 uppercase tracking-widest opacity-80">
              Trường Đại học Công nghệ Thông tin - ĐHQG-HCM
            </span>
          </div>
          <div className="z-10 flex flex-col items-center justify-center mt-12">
            <h1 className="text-6xl font-bold mb-6 tracking-wide uppercase">
              {slide.title}
            </h1>
            <hr className="w-64 border-2 border-white mb-6 opacity-50 mx-auto" />
            <h2 className="text-4xl text-blue-200 font-bold mb-16">
              {slide.subtitle}
            </h2>

            {slide.content?.map((item, i) => (
              <p key={i} className="text-2xl text-blue-100">
                {item}
              </p>
            ))}
          </div>
